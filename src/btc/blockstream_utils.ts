...
// export const OPENAPI_URL_MAINNET = 'https://mempool-testnet.fractalbitcoin.io/api';
// export const OPENAPI_URL_TESTNET = 'https://mempool-testnet.fractalbitcoin.io/api';
